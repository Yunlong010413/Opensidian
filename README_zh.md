...
它是优秀的 [Claudian](https://github.com/shabegom/claudian) 插件的一个功能丰富的分支/移植版本，扩展了多 AI 供应商支持、自定义模型和增强的个性化设置。
...
## ❤️ 致谢
基于 Shabegom 的 [Claudian](https://github.com/shabegom/claudian) 插件开发。
